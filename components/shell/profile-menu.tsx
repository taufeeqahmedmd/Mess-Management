...
/**
 * Profile avatar + dropdown. Auth lands in Phase 1, so this shows a signed-out
 * state (Sign in link) plus an appearance (theme) control and a disabled Sign out.
 */
        ...
        >
          ...
          <div className="border-t border-line p-1.5">
            <button
              ...
              role="menuitem"
              disabled
              className="flex w-full items-center gap-3 rounded-sm px-3 py-2 text-sm text-muted-2"
            >
